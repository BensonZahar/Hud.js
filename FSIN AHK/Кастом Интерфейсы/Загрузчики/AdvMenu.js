...
const _GH_URL = 'https://raw.githubusercontent.com/BensonZahar/Hud.js/main/FSIN%20AHK/'
              + encodeURIComponent('Кастом Интерфейсы') + '/' + encodeURIComponent('Загрузчики') + '/AdvMenu.js';
