(function() {
// Звание, имя и фамилия теперь берутся автоматически из mvdF.js (window._mvdRank и т.д.)
// Позывной оставлен для ручного переопределения (например, для СОБР/ОМОН)
const CALLSIGN = "";
