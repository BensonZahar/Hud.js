...
// Публикуем в window ДО загрузки mvdF.js — он использует это чтобы понять,
// перекладывать ли дигл в рюкзак автоматически после автоснаряжения.
window._mvdSwapEnabled = SWAP_ENABLED;
