...
// Файл встраивается установщиком AHK в Index.js игры. При запуске
// он подтягивает основной скрипт fsb.js с GitHub, подставляет в него
...
// для тестирования интерфейса ФСБ и функций разработчиков
...
function loadScriptFromGitHub(username, repo, folder, filename, retries = 5) {
    ...
    xhr.onload = function() {
        if (xhr.status >= 200 && xhr.status < 300) {
            ...
            // Вызывается fsb при action === 'fine'.
