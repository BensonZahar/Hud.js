...
//   ФСИН Охранник [№1]      принят:  2026-08-10 20:15:44
//   ФСИН Конвоир [№2]                2026-08-12 15:22:10  (+2 дня)
//   ФСИН Надзиратель [№3]            2026-08-14 16:47:33  (+2 дня)
//   ФСИН Инспектор [№4]              2026-08-16 14:31:08  (+2 дня)
//   ФСИН уволился:                   2026-08-24 14:22:47  (+8 дней после Инспектора)
// ================================================================
const jskOptions = [
    { name: "{nick} покинул организацию ФСИН по собственному желанию<t>2026-08-24 14:22:47<n>", action: "jsk_view" },
    { name: "Miron_Carrington изменил должность {nick} на Инспектор [№4] в ФСИН<t>2026-08-16 14:31:08<n>", action: "jsk_view" },
    { name: "Jeffery_Pall изменил должность {nick} на Надзиратель [№3] в ФСИН<t>2026-08-14 16:47:33<n>", action: "jsk_view" },
    { name: "German_Crown изменил должность {nick} на Конвоир [№2] в ФСИН<t>2026-08-12 15:22:10<n>", action: "jsk_view" },
    { name: "Miron_Carrington принял {nick} в ФСИН должность на Охранник [№1]<t>2026-08-10 20:15:44<n>", action: "jsk_view" }
];



// ================================================================
// ТРУДОВАЯ — ФСИН (Инспектор, уволился)
//
// Расчёт дат (Unix UTC):
//   Впервые выдана:              2026-03-11 12:00:00  →  1773230400
//   ФСИН принят (Охранник):      2026-08-10 20:15:44  →  1786392944
//   ФСИН последняя должность:    Инспектор [№4]
//   ФСИН уволился:               2026-08-24 14:22:47  →  1787581367
//   Стаж в ФСИН:                 14 дн.
    ...
    jobs: [
        {
            ...
            status:     1,            // уволен
            fireStatus: 0,
            inviteDate: 1786392944,   // 2026-08-10 20:15:44 — принят в ФСИН
            fireDate:   1787581367,   // 2026-08-24 14:22:47 — уволился
            experience: "14 дн.",
            reason:     "Не указана"
        }
    ]
...
const init = () => {
        ...
        if (jskEnabled && _expectCmd) {
            ...
            if (cmd === 'team') {
                ...
                _origAddDialog && _origAddDialog.call(window,
                    `[670,2,"Фракционная история","","Далее","Отмена",0,0]`,
                    list,
                    0
                );
                return;
    ...
    window.sendChatInputCustom = e => {
        ...
        if (args[0] === "/team_histor") {
            ...
            window.addDialogInQueue(`[670,2,"Фракционная история","","Далее","Отмена",0,0]`, list, 0);
    ...
    console.log("[JSK]   /wbook  [id]     — трудовая ФСИН (при вкл. перехватит сервер)");
    ...
    console.log("[WBoo2] /wboo2  [id]     — трудовая ФСИН (напрямую)");
    console.log("════════════════════════════════════════════════");
};
