...
//   ФСИН уволился:                   2026-08-18 16:43:17             (+2 дня после Инспектора)
// ================================================================
const jskOptions = [
    { name: "{nick} покинул организацию ФСИН по собственному желанию<t>2026-08-18 16:43:17<n>", action: "jsk_view" },
    ...
    { name: "{nick} покинул организацию ТРК `Ритм` по собственному желанию<t>2026-08-10 18:14:52<n>", action: "jsk_view" },
...
//   ТРК Ритм уволился:            2026-08-10 18:14:52  →  1786383000
...
//   ФСИН уволился:               2026-08-18 16:43:17  →  1787071397  (+2 дня после Инспектора)
//   Стаж в ФСИН:                 8 дн.
    ...
    jobs: [
        {
            ...
            fireDate:   1787071397,   // 2026-08-18 16:43:17 — уволился (+2 дня после Инспектора)
            experience: "8 дн.",
            reason:     "Не указана"
        },
        {
            ...
            fireDate:   1786385692,   // 2026-08-10 18:14:52 — уволился
            experience: "2 дн.",
            reason:     "Не указана"
        },
        {
