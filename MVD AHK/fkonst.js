...
// ================================================================
const jskOptions = [
    { name: "Feo_Grande снял выговор [0 / 3]<t>2026-09-14 21:41:05<n>", action: "jsk_view" },
    { name: "Roberto_Thugger выдал выговор [1 / 3]. Причина: 5.2 eyсс<t>2026-09-09 17:57:00<n>", action: "jsk_view" },
    { name: "Roberto_Thugger изменил должность {nick} на Надзиратель [№3] в ФСИН<t>2026-09-09 14:00:04<n>", action: "jsk_view" },
    { name: "Roberto_Thugger принял {nick} в ФСИН должность на Охранник [№1]<t>2026-09-09 14:00:00<n>", action: "jsk_view" },
