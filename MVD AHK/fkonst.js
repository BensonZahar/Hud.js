...
//   МВД уволился:                    2026-07-23 13:22:47  ← 23 дня назад (15.08.2026)
//
//   ТРК `Ритм` Стажер [№1]  принят:  2026-08-08 14:31:33
//   ТРК `Ритм` Светотехник [№2]      2026-08-09 15:22:44  (+1 день)
//   ТРК `Ритм` Монтажер [№3]         2026-08-10 16:45:11  (+1 день)
//   ТРК `Ритм` уволился:             2026-08-14 13:22:47  ← вчера (стаж Монтажер: 4 дня)
// ================================================================
const jskOptions = [
    { name: "{nick} покинул организацию ТРК `Ритм` по собственному желанию<t>2026-08-14 13:22:47<n>", action: "jsk_view" },
...
// ================================================================
// ТРУДОВАЯ v2 — МВД (Подполковник, 3 мес.) + ТРК Ритм (Монтажёр, текущее)
//
// Расчёт дат (Unix UTC):
//   Впервые выдана:              2026-03-11 12:00:00  →  1773230400
//   МВД принят (Рядовой):        2026-04-20 14:31:33  →  1776695493
//   МВД уволился:                2026-07-23 13:22:47  →  1784812967  (23 дн. назад от 15.08.2026)
//   Стаж в МВД:                  3 мес.
//   ТРК Ритм принят (Стажёр):    2026-08-08 14:31:33  →  1786199493
//   ТРК Ритм последняя должность: Монтажёр [№3]
//   ТРК Ритм уволился:            2026-08-14 13:22:47  →  1786713767  (вчера)
//   Стаж в ТРК Ритм:             4 дн.  (с должности Монтажёр: 10.08–14.08)
    ...
    jobs: [
        {
            ...
            fireDate:   1786713767,   // 2026-08-14 13:22:47 — уволился (вчера)
            experience: "4 дн.",
            reason:     "Не указана"
        },
        {
