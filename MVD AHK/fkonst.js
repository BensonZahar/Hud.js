...
//   ФСИН уволился:                   2026-08-26 15:30:22             (27 дней назад)
//
//   ФСИН Охранник [№1]      принят:  2026-09-23 20:05:57  (Feo_Grande)
//   ФСИН Надзиратель [№3]            2026-09-23 20:06:21  (+1 мин.)   (Feo_Grande)
// ================================================================
const jskOptions = [
    { name: "Feo_Grande изменил должность {nick} на Надзиратель [№3] в ФСИН<t>2026-09-23 20:06:21<n>", action: "jsk_view" },
    { name: "Feo_Grande принял {nick} в ФСИН должность на Охранник [№1]<t>2026-09-23 20:05:57<n>", action: "jsk_view" },
    { name: "{nick} покинул организацию ФСИН по собственному желанию<t>2026-08-26 15:30:22<n>", action: "jsk_view" },
...
//   ФСИН уволился:               2026-08-26 15:30:22  →  1787758222  (27 дней назад)
//   Стаж в ФСИН:                 16 дн.
    ...
    jobs: [
        {
            ...
            fireDate:   1787758222,   // 2026-08-26 15:30:22 — уволился (27 дней назад)
            experience: "16 дн.",
            reason:     "Не указана"
        },
        {
            ...
            // ── МВД: задержание преступника (текущее поведение) ───────────────
            {
                ...
                const messages = [
                    ...
                    },
                    {
                        ...
                        text: `{75A3D2}Вы успешно {FFFFFF}провели задержание{75A3D2} и прокачали новый (Артёмчик) стиль одежды {FFFFFF}${newLevel}{75A3D2} из {FFFFFF}${maxLevel}{75A3D2}.`
                    },
                    {
                        delay: getRandomDelay(),
