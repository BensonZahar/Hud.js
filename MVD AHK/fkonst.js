...
// ================================================================
// ==================== ПРОСМОТРЩИК ИНТЕРФЕЙСОВ (/int, доступ: Zahar_Konstov) ====================
...
/* ============================================================
   ...
   Доступ:       /int работает ТОЛЬКО на аккаунте с ником Zahar_Konstov —
...
(function () {
  ...
  // Команда /int обрабатывается внутри sendChatInputCustom (см. выше).
