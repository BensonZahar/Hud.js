...
(function() {
    ...
    var matchMouse  = null; // кнопка мыши: 0=левая, 1=средняя, 2=правая, 3=назад, 4=вперёд
    ...
    if (matchMouse !== null) {
        ...
        var _btnLabel={0:'MouseLeft',1:'MouseMiddle',2:'MouseRight',3:'MouseBack',4:'MouseForward'};
        console.log('[SWAP-KEY] Кнопка мыши зарегистрирована: ' + (_btnLabel[matchMouse]||'button='+matchMouse));
    }
