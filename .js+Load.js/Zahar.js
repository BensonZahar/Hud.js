...
У нас щас autoReconnectEnabled: true когда false всё должно работать без /rec и не должно быть выбора с реконектом или без так как рекконект полностью отключен вот старый код где всё было без рекконекта
...
нужно сделать так что если false то рекконекта тоесть /rec нет вообще и нет выбора и действия останутся как в старом коде
