...
(function () {
    ...
    // ── Маппинг keyCode → key кнопки мобильного HUD ──────────────────
    // Эти имена совпадают с key-пропом UIMobileButton в hud-hassle-controls
    const KEY_TO_HUD_BUTTON = {
        87: 'PedalGas',    // W  — Газ
        83: 'PedalStop',   // S  — Тормоз
        65: 'TurnLeft',    // A  — Влево (руль)
        68: 'TurnRight',   // D  — Вправо (руль)
        32: 'HandBrake',   // Space — Ручник
        72: 'Beep',        // H  — Сигнал
        // Q (81) и E (69) — клавиши поворотников, отдельных
        // мобильных кнопок в speedometer-режиме не имеют
    };
